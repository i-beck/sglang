...
class NanoNemotronVLImageProcessor(BaseMultimodalProcessor):
    ...
    def __init__(self, hf_config, server_args, _image_processor, *args, **kwargs):
        ...
        self.AUDIO_CONTEXT_TOKEN = getattr(
            hf_config, "audio_context_token", " <audio>"
        )
        self.AUDIO_START_TOKEN = getattr(hf_config, "audio_start_token", "<audio>")
        self.AUDIO_END_TOKEN = getattr(hf_config, "audio_end_token", "</audio>")
